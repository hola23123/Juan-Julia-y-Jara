...
R-cuadrado (0.04748): Este valor indica que aproximadamente el 4.75% de la variabilidad en la edad puede ser explicada por las variables independientes en el modelo. Aunque es significativo, sugiere que la mayor parte de la variabilidad en la edad se debe a otros factores no incluidos en el modelo.

R-cuadrado Ajustado (0.0464): Este valor es ligeramente inferior al R-cuadrado, ajustando el número de variables en el modelo.

F-Statistic (43.91): El valor de F-Statistic y su p-value (\< 2.2e-16) sugieren que el modelo en su conjunto es significativo, lo que significa que las variables independientes seleccionadas, en conjunto, explican una cantidad significativa de la variabilidad en la edad.
